...
## Descripción
He escondido una bandera en este archivo. ¿Puedes encontrarla? [La ciencia forense es divertida.pptm](https://mercury.picoctf.net/static/d3dd8cd51524d9fafcccd1b7d55f85e7/Forensics%20is%20fun.pptm)
...
--2023-04-01 00:32:56--  https://mercury.picoctf.net/static/d3dd8cd51524d9fafcccd1b7d55f85e7/Forensics%20is%20fun.pptm
...
Forensics is fun.pptm         100%[===============================================>]  97.75K   162KB/s    in 0.6s    

2023-04-01 00:32:57 (162 KB/s) - ‘Forensics is fun.pptm’ saved [100093/100093]
...
## Notas adicionales
Los archivos .pptm pueden ser descomprimidos para ver toda la conformación de su estructura de archivos.

| Comando | Descripción |
|--------|--------|
| find | Buscar archivos en una jerarquía de directorios |
| tr -d | Borra caracteres dados a continuación |
| base64 -d | Decodifica datos en base 64 |

## Referencias
[Qué es un archivo PPTM](https://www.online-convert.com/es/formato-de-archivo/pptm#:~:text=Los%20archivos%20con%20la%20extensi%C3%B3n%20PPTM%20solo%20pueden%20abrirse%20con,el%20componente%20Open%20XML%20instalado.)
[find(1) - Linux man page](https://linux.die.net/man/1/find)
[tr(1) - Linux man page](https://linux.die.net/man/1/tr)
[base64(1) - Linux man page](https://linux.die.net/man/1/base64)