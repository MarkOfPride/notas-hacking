...
## Descripción
¿Qué le parece si le llevamos a explorar las solicitudes de firma de certificados?
Eche un vistazo a este archivo CSR [aquí](https://artifacts.picoctf.net/c/421/readmycert.csr).

## Pistas
- Descargue la solicitud de firma de certificado e intente leerla

## Solución
```bash
┌──(kali㉿kali)-[~/picoctf/cryptography/ReadMyCert]
└─$ wget https://artifacts.picoctf.net/c/421/readmycert.csr
--2023-04-30 22:51:11--  https://artifacts.picoctf.net/c/421/readmycert.csr
...
2023-04-30 22:51:12 (13.5 MB/s) - ‘readmycert.csr’ saved [997/997]
...
>[!info]
>**CSR**
>Una CSR o "solicitud de firma de certificado" es un bloque de texto cifrado que se genera en el servidor en el que se utilizará el certificado.

| Comando | Descripción |
|--------|--------|
| openssl | Decodifica su solicitud de firma de certificado y verifica que contiene la información correcta |

## Referencias
[HowTo: Decode CSR](https://www.shellhacks.com/decode-csr/)