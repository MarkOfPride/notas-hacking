...
El sitio web funciona [aquí](http://saturn.picoctf.net:53932/)
...
```bash
┌──(kali㉿kali)-[~]
└─$ curl http://saturn.picoctf.net:53932/                          
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    ...
    <div class="imgcontainer">
      ...
      />
      <div class="top-left">
        <h1>If security wasnt your job, would you do it as a hobby?</h1>
      </div>
    </div>
  </body>
</html>
...
┌──(kali㉿kali)-[~]
└─$ curl http://saturn.picoctf.net:53932/secret/                   
<!DOCTYPE html>
<html>
  <head>
    <title></title>
...
┌──(kali㉿kali)-[~]
└─$ curl http://saturn.picoctf.net:53932/secret/hidden/            
<!DOCTYPE html>
<html>
  <head>
    <title>LOGIN</title>
...
┌──(kali㉿kali)-[~]
└─$ curl http://saturn.picoctf.net:53932/secret/hidden/superhidden/
<!DOCTYPE html>
<html>
  <head>
    <title></title>
